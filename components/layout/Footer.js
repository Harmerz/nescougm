...
export function Footer() {
  ...
  return (
    <div className="h-[50vh] bg-c-00 flex items-center justify-center lg:justify-around lg:flex-row flex-col gap-y-6">
      <div className="lg:flex-row flex-col items-center flex">
        <div className="w-24 h-24 bg-slate-400 mb-3 lg:m-0"></div>
        <div className="w-[210px] h-[60px] lg:ml-4">
          <Image src={'/Nesco-Footer.png'} alt="Tutur" width={210} height={60} />
        </div>
      </div>
      <div className="flex-col flex">
        <div className="text-lg text-c-01 font-jost font-bold flex justify-center">QUICK LINKS</div>
        {competition.map((text, index) => (
          <div
