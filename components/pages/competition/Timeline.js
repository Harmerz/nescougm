...
export function Timeline({ tujuh = false }) {
  return (
    <div className="box-content pt-[7vh] lg:py-[5vh] w-full lg:h-[100vh] bg-c-00 flex items-center relative">
      ...
      <div className="hidden lg:block h-4/5 w-[2%] ml-[3.5%]">
      ...
      <div className="w-full h-full flex justify-center relative lg:static mt-[7vh] lg:mt-0 box-content pb-[5vh] lg:pb-0">
        <div className="lg:h-[20%] absolute inset-y-0 inset-x-[43%] lg:inset-0 lg:my-auto bg-gradient-to-t lg:bg-gradient-to-l from-c-01 to-c-02 flex items-center overflow-hidden">
          <div className="hidden lg:block h-[400%] w-[2%] ml-[3.5%]">
            <VerticalBar title="Timeline" color="white" />
          </div>
        </div>
        <div className="w-full h-full flex flex-col items-center justify-center z-[10] lg:ml-[5%]">
          <div className="absolute w-1/2 mx-auto inset-x-0 text-center -top-[7vh] lg:top-[15%] text-2xl md:text-3xl lg:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-b from-c-01 to-c-02">
            Timeline
          </div>
          <div className="lg:mr-[8%] w-full h-full flex flex-col lg:flex-row justify-evenly">
