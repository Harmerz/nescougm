...
export function HeroCompetition() {
  return (
    <div className="w-full h-[90vw] lg:h-[100vh] bg-bg-01 flex justify-center items-center relative overflow-hidden">
      <Image src={Vector0} className="w-[40%] absolute right-0 top-0 z-[9]" />
      <Image src={Vector1} className="w-[15%] absolute left-0 bottom-[1vh] z-[9]" />
