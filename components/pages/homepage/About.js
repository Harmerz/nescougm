  ...
  return (
    <div className="shadow-xl h-[100vh] bg-gradient-to-t p-[6px] from-c-01 to-bg-02">
      <div className="grid items-center bg-bg-02 h-[98vh]">
        <div className="flex invisible sm:visible justify-start self-start h-[5vh] lg:h-[10vh] sm:ml-10 sm:mt-5">
          <img
        ...
        <div className="lg:flex grid justify-center place-items-center h-[75] sm:h-[65vh]">
          <div className=" grid sm:self-start lg:self-center place-self-center w-[250px] sm:w-[500px] lg:w-[450px] xl:w-[550px] mt-6 sm:mt-4 lg:ml-8 xl:ml-0 xl:mr-16">
            ...
            <div className="w-[250px] sm:w-[500px] lg:w-[420px] xl:w-[550px] text-[12px] xl:text-[15px] text-justify font-medium font-poppins leading-[36.75px] mt-4 sm:mt-4 lg:mt-8 text-white">
        ...
        <div className="invisible sm:visible flex justify-end self-end h-[10vh] sm:mr-4 lg:mr-24 xl:mr-56 mb-5">
          <img src="/Group 608.svg" alt="vektor" width={338} height={403.5} />
        </div>
      </div>
    </div>
  )
