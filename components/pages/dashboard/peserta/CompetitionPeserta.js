...
export function CompetitionPeserta({ data, paymentStatus }) {
    ...
    <>
      ...
      <div className="flex flex-col w-full items-center justify-center">
        ...
        <div className="bg-[#22292F] drop-shadow-[0_0_14px_rgba(0,0,0,0.25)] rounded-xl w-full items-center justify-center flex flex-col md:px-6 px-[16px] py-[25px] md:py-11 mb-[150px]">
          ...
          {data?.savePermanent && data?.selectedCompetition === 'Lomba Poster' ? (
            <JumlahKarya />
          ) : null}
          {data?.savePermanent ? (
            <Pembayaran
          ...
          {paymentStatus ? <PengumpulanKarya data={data} /> : null}
        </div>
      </div>
    </>
  )
