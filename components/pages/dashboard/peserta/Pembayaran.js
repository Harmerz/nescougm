...
export function Pembayaran() {
  return (
    <div className="flex flex-col mt-10 xl:w-4/5 w-11/12 h-4/5 bg-bg-01 rounded-xl p-12">
      <div
      ...
      <div className="flex-row flex mt-6">
        <div className="w-1/2 text-white font-jost text-base">
          <p>
        ...
        <div className="flex flex-col w-1/2 justify-end items-start">
          <div className="w-full flex justify-end">
            <div className="justify-end w-4/5">
              <form>
                <label>
                  <input
                    type="file"
